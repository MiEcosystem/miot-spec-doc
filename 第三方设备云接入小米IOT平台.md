...
>  在iot.mi.com上定义设备,厂商可以查询相关文档[https://iot.mi.com/new/guide.html#/?id=86](https://iot.mi.com/new/guide.html#/?id=86	"定义产品功能")。定义好设备之后就能拿到产品的type如下图↓,后面[实现接口](#二实现接口)

![IoT上的设备type](images/type.jpg)



### 3. 厂家提供服务器地址并实现接口。 

    目前在example里提供了java版的demo实现，仅供参考
...
* 应答（第三方云 -> MIOT）
  ...
  | [type](#21创建设备流程) | 设备类型，在小米IOT开放平台创建产品时，在产品信息里的[产品Type](#21创建设备流程)字段。 |
